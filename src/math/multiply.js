...
/**
 * Multiplies two objects values together, this is safe if they are flat, and only strings/numbers
 ...
 * @param deep
 */
module.exports = function multiply(obj1, obj2, deep){
    return require('./../jsonOperation')(obj1, obj2, deep, function multiplication(o1, o2){
